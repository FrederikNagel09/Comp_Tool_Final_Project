...
def _hungarian_accuracy(y_true, y_pred, labels_true, labels_pred):
    ...
    """
    cm = confusion_matrix(y_true, y_pred, labels=labels_true + labels_pred)  # safe: we'll slice below
...
def cluster_accuracy_ignore_noise(y_true, y_pred):
    ...
    return _hungarian_accuracy(y_true[mask], y_pred[mask],
...
def cluster_accuracy_count_noise_as_wrong(y_true, y_pred):
    ...
    matched_assigned = _hungarian_accuracy(y_true[mask_assigned], y_pred[mask_assigned],
